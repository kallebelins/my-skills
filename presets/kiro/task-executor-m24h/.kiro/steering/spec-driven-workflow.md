...
1. Read and follow the installed `task-executor-m24h` skill before acting.
...
This project expects the `spec-kit` and `task-executor-m24h` skills from [kallebelins/my-skills](https://github.com/kallebelins/my-skills) to be installed and available to the agent.
